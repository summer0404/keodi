...
export const ReviewErrorMessages = {
  ...
  REVIEW_NOT_ON_YOUR_PLACE: 'REVIEW_NOT_ON_YOUR_PLACE',
  REVIEW_ALREADY_RESPONDED: 'REVIEW_ALREADY_RESPONDED',
  REVIEW_NOT_RESPONDED: 'REVIEW_NOT_RESPONDED',
  REVIEW_ALREADY_FLAGGED: 'REVIEW_ALREADY_FLAGGED',
  REVIEW_NO_PENDING_FLAG: 'REVIEW_NO_PENDING_FLAG',
} as const;
